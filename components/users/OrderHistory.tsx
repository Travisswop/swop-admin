...
const OrderHistory = ({
  ...
  return (
    <div className="w-full h-full grid grid-cols-2 gap-5 py-10">
      <Card className="col-span-2 px-7 py-5 shadow-lg">
        <CardHeader className="col-span-2 p-2 border-b text-black text-2xl float-left w-full">
          Order History
        </CardHeader>
        <section className="w-full pt-5 col-span-2 h-[250px]  flex justify-center items-center ">
